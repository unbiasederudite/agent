...
- `__init__.py` — `AgentError` (the root), `ConfigError`, `LLMNotFoundError`, `AgentNotFoundError`, `ToolNotFoundError`, `StrategyNotFoundError`, `LLMError` (with `LLMRateLimitedError`, `LLMTimeoutError`)
